...
Project Overview
This project undertakes the clustering of Ethereum addresses active on Uniswap to categorize them based on trading behavior throughout the 2020-2022 crypto bull run. Utilizing data from Dune Analytics, this analysis aims to differentiate among various trader profiles, from amateur enthusiasts to sophisticated 'whales' and automated bots.
